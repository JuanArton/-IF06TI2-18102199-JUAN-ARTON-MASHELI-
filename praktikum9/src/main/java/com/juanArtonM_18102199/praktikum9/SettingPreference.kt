...
internal class SettingPreference(context: Context) {
    companion object {
        ...
        private const val UNIV = "univ"
        private const val SLOGAN = "slogan"
    }
    ...
    fun setSetting(value: SettingModel) {
        ...
        editor.putString(UNIV, value.univ)
        editor.putString(SLOGAN, value.slogan)
        editor.apply()
    }
    ...
    fun getSetting(): SettingModel {
        ...
        model.univ = preferences.getString(UNIV, "")
        model.slogan = preferences.getString(SLOGAN, "")
        return model
    }
}