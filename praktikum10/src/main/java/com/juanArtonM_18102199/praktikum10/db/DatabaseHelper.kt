package com.juanArtonM_18102199.praktikum10.db

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import android.database.sqlite.SQLiteOpenHelper
import com.juanArtonM_18102199.praktikum10.db.DatabaseContract.QuoteColumns.Companion.TABLE_QUOTE
    ...
    internal class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME,
        ...
        companion object {
            ...
            private const val SQL_CREATE_TABLE_QUOTE = "CREATE TABLE $TABLE_QUOTE" +
                    ...
                    " ${DatabaseContract.QuoteColumns.OLEH} TEXT NOT NULL," +
                    " ${DatabaseContract.QuoteColumns.RATING} TEXT NOT NULL)"
        }
